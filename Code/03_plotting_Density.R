...
load("Data\\Bootstrap\\density-competition_boot-metrics-unnest.rdata")
load("Data\\CleanData\\density_coef.rdata")
...
ggsave(filename = "Data\\Figures\\density-competition_intrinsic-growth.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\density-competition_intrinsic-growth.pdf", width = 10, height = 7)
...
ggsave(filename = "Data\\Figures\\density-competition_comp-coef.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\density-competition_comp-coef.pdf", width = 10, height = 7)
...
boot.summary.comp_outcome %>% 
  ...
  labs(#title = "competitive outcome ratio affected by density dependent competition", 
    y = "proportion of bootstrap replicates (%)")


ggsave(filename = "Data\\Figures\\density-competition_comp-outcome.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\density-competition_comp-outcome.pdf", width = 10, height = 7, device = cairo_pdf)
...
ggsave(filename = "Data\\Figures\\density-competition_persist.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\density-competition_persist.pdf", width = 10, height = 7, device = cairo_pdf)
...
# write.csv(summary_boot.a, file = "density-competition_boot_a.csv")
# write.csv(summary_boot.b1, file = "density-competition_boot_b1.csv")
# write.csv(summary_boot.b2, file = "density-competition_boot_b2.csv")
# write.csv(boot.summary.comp_outcome, file = "density-competition_boot_comp_outcome.csv")
# write.csv(E_persist, file = "density-competition_boot_E_persist.csv")
# write.csv(M_persist, file = "density-competition_boot_M_persist.csv")
