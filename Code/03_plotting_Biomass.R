...
load("Data\\Bootstrap\\biomass-competition_boot-metrics-unnest.rdata")
load("Data\\CleanData\\biomass_coef.rdata")
...
ggsave(filename = "Data\\Figures\\biomass-competition_intrinsic-growth.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\biomass-competition_intrinsic-growth.pdf", width = 10, height = 7)
...
ggsave(filename = "Data\\Figures\\biomass-competition_comp-coef.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\biomass-competition_comp-coef.pdf", width = 10, height = 7)
...
ggsave(filename = "Data\\Figures\\biomass-competition_comp-outcome.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\biomass-competition_comp-outcome.pdf", width = 10, height = 7, device = cairo_pdf)
...
ggsave(filename = "Data\\Figures\\biomass-competition_persist.jpg", width = 10, height = 7)
ggsave(filename = "Data\\Figures\\biomass-competition_persist.pdf", width = 10, height = 7, device = cairo_pdf)
