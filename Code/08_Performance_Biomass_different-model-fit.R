...
# save(coef, file = "Data\\CleanData\\biomass-08_coef.rdata")
...
ggsave(filename = "Data\\Figures\\biomass-competition_model-fit08.jpg", width = 7, height = 7)
ggsave(filename = "Data\\Figures\\biomass-competition_model-fit08.pdf", width = 7, height = 7)
...
# save(boot.metrics.unnest, file = "Data\\Bootstrap\\biomass-competition-08_boot-metrics-unnest.rdata")
