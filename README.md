...
Data and R scripts for Huang et al.: Plant–soil feedback persists beyond host death to shape density-dependent plant competition. *Plant and Soil*. Note that bootstrapping can take some time to run. Figures can also be directly generated by using the saved /Bootstrap .rdata files.
